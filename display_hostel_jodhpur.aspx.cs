...
public partial class display_hostel_jodhpur : System.Web.UI.Page
{
    ...
    private void commentct()
    {
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("select * from tbl_property where p_cat='Hostel' and city='Jodhpur' AND p_status NOT IN ('Approve')", con);
