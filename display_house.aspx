<%@ Page Language="C#" AutoEventWireup="true" CodeFile="display_house.aspx.cs" Inherits="display_house" %>
...
<div class="container">
    <asp:DataList ID="dlc" runat="server"  CellPadding="4" RepeatColumns="1" width="100%" ItemStyle-BorderWidth="50" ItemStyle-BorderColor="White" ForeColor="#333333" OnItemCommand="dlc_ItemCommand">
                    ...
                    <td>
                        <table>
                            <tr><td><h4><asp:Label ID="lbl_p_pricing" runat="server" Text='<%#Eval("p_pricing")%>' ></asp:Label></h4></td>
                                <td>&nbsp / &nbsp</td>
                                <td><asp:Label ID="lbl_duration" runat="server" Text='<%#Eval("p_duration")%>' ></asp:Label></td>
                            </tr>
                        </table>
                    </td>
                </tr>
