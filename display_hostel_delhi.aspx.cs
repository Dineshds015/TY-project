...
public partial class display_hotel_delhi : System.Web.UI.Page
{
    ...
    private void commentct()
    {
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("select * from tbl_property where p_cat='Hostel' and city='Delhi' AND p_status NOT IN ('Approve')", con);
