...
public partial class display_party_plot : System.Web.UI.Page
{
    ...
    private void commentct()
    {
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("select * from tbl_property where p_cat='Party Plot' AND p_status NOT IN ('Approve')", con);
