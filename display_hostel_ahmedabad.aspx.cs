...
public partial class display_hostel_ahmedabad : System.Web.UI.Page
{
    ...
    private void commentct()
    {
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("select * from tbl_property where p_cat='Hostel' and city='Ahmedabad' AND p_status NOT IN ('Approve')", con);
