...
public partial class display_bike : System.Web.UI.Page
{
    ...
    private void commentct()
    {
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("select * from tbl_property where p_cat='Bike' AND p_status NOT IN ('Approve')", con);
