...
public partial class display_books_ahmedabad : System.Web.UI.Page
{
    ...
    private void commentct()
    {
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("select * from tbl_property where p_cat='Books' and city='Ahmedabad' AND p_status NOT IN ('Approve')", con);
