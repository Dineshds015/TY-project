...
public partial class display_home_delhi : System.Web.UI.Page
{
    ...
    private void commentct()
    {
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("select * from tbl_property where p_cat='House' and city='Delhi' AND p_status NOT IN ('Approve')", con);
