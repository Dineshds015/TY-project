...
public partial class display_delhi : System.Web.UI.Page
{
    ...
    private void commentct()
    {
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("select * from tbl_property where city='Delhi' AND p_status NOT IN ('Approve')", con);
