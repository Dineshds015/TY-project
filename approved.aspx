...
<div class="container" >
    <asp:DataList ID="dlc" runat="server" RepeatColumns="1" CellPadding="4" ForeColor="#333333" OnItemCommand="dlc_ItemCommand"  width="100%">
        ...
        <ItemTemplate >
            ...
            <table width="100%">
                <tr>
                    <td><asp:Button ID="Button3" runat="server" Text='<%#Eval("e_email") %>' class="btn btn-primary transparent-style mr-3" Width="100%"/></td>
                    <td><asp:Button ID="Button4" runat="server" Text='<%#Eval("e_phone") %>' class="btn btn-primary transparent-style mr-3" Width="100%"/></td>
                </tr>
            </table>
            <br />
            <table width="100%">
                <tr>
                    <td><asp:Button ID="btn_delete" runat="server" Text="Discharge" class="btn btn-warning transparent-style mr-3" CommandName="delete" Width="100%"/></td>
                </tr>
            </table>
