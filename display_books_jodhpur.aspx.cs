...
public partial class display_books_jodhpur : System.Web.UI.Page
{
    ...
    private void commentct()
    {
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("select * from tbl_property where p_cat='Books' and city='Jodhpur' AND p_status NOT IN ('Approve')", con);
