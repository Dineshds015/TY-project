...
public partial class display_cloths : System.Web.UI.Page
{
    ...
    private void commentct()
    {
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("select * from tbl_property where p_cat='Cloths' AND p_status NOT IN ('Approve')", con);
    ...
    {
        Response.Write("btn_project_Click");
    }
