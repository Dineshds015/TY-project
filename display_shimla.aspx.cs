...
public partial class display_shimla : System.Web.UI.Page
{
    ...
    private void commentct()
    {
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("select * from tbl_property where city='Shimla' AND p_status NOT IN ('Approve')", con);
