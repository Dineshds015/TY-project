<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_management.aspx.cs" Inherits="user_management" %>
        ...
        <Columns>  
            <asp:TemplateField HeaderText="Actions">  
                ...
                <asp:TemplateField HeaderText="ID">  
                    <ItemTemplate>  
                        <asp:Label ID="lbl_ID" runat="server" Text='<%#Eval("c_id") %>'></asp:Label>  
                    </ItemTemplate>  
                </asp:TemplateField>  
                <asp:TemplateField HeaderText="Name">  
                    <ItemTemplate>  
                        <asp:Label ID="lbl_c_name" runat="server" Text='<%#Eval("c_name") %>'></asp:Label>  
                    </ItemTemplate>  
                    <EditItemTemplate>  
                        <asp:TextBox ID="txt_c_name" runat="server" Text='<%#Eval("c_name") %>'></asp:TextBox>  
                    </EditItemTemplate>  
                </asp:TemplateField>  
                <asp:TemplateField HeaderText="Contact">  
                    <ItemTemplate>  
                        <asp:Label ID="lbl_c_phone" runat="server" Text='<%#Eval("c_phone") %>'></asp:Label>  
                    </ItemTemplate>  
                    <EditItemTemplate>  
                        <asp:TextBox ID="txt_c_phone" runat="server" Text='<%#Eval("c_phone") %>'></asp:TextBox>  
                    </EditItemTemplate>  
                </asp:TemplateField>  
                 <asp:TemplateField HeaderText="Email">  
                    <ItemTemplate>  
                        <asp:Label ID="lbl_c_email" runat="server" Text='<%#Eval("c_email") %>'></asp:Label>  
                    </ItemTemplate>  
                    <EditItemTemplate>  
                        <asp:TextBox ID="txt_c_email" runat="server" Text='<%#Eval("c_email") %>'></asp:TextBox>  
                    </EditItemTemplate>  
                </asp:TemplateField>  
             <asp:TemplateField HeaderText="Pincode">  
                    <ItemTemplate>  
                        <asp:Label ID="lbl_c_pin" runat="server" Text='<%#Eval("c_pin") %>'></asp:Label>  
                    </ItemTemplate>  
                    <EditItemTemplate>  
                        <asp:TextBox ID="txt_c_pin" runat="server" Text='<%#Eval("c_pin") %>'></asp:TextBox>  
                    </EditItemTemplate>  
                </asp:TemplateField>  
             <asp:TemplateField HeaderText="City">  
                    <ItemTemplate>  
                        <asp:Label ID="lbl_c_city" runat="server" Text='<%#Eval("city") %>'></asp:Label>  
                    </ItemTemplate>  
                    <EditItemTemplate>  
                        <asp:TextBox ID="txt_c_city" runat="server" Text='<%#Eval("city") %>'></asp:TextBox>  
                    </EditItemTemplate>  
                </asp:TemplateField>  
