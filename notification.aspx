...
<div class="container">
  <table width="100%">
      <tr>
          <td><asp:Button ID="approved" runat="server" Text="Approved" class="btn btn-success transparent-style mr-3" Width="100%" Onclick="btn_approved_Click"/></td>
      </tr>
  </table>
</div>
<br /><br /><br /><br />
...
<div class="container" >
    <asp:DataList ID="dlc" runat="server" RepeatColumns="1" CellPadding="4" ForeColor="#333333" OnItemCommand="dlc_ItemCommand"  width="100%">
        ...
        <ItemTemplate >
            <table>
                <tr>
                    <td rowspan="8"><asp:Image ID="img_p_image" runat="server" ImageUrl='<%#Eval("e_image") %>' Type="String" Height="150px" Width="300px"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td>
                    <%--<td>Renter</td><td>:&nbsp</td>  <td><asp:Label ID="lbl_email" runat="server" Text='<%#Eval("e_email") %>'></asp:Label></td>--%>
                </tr>
                ...
                <tr>
                    <td><asp:Label ID="Label1" runat="server" style="color:#8e8e8e" Text='<%#Eval("e_time","{0:dd/MM/yyyy | hh:mm:ss}") %>'></asp:Label>  </td>
                </tr>
            </table>
            <table width="100%">
                <tr>
                    <td><asp:Button ID="Button3" BackColor="aqua" runat="server" Text='<%#Eval("e_email") %>' class="btn transparent-style mr-3" Width="100%"/></td>
                </tr>
            </table>
            <br />
            <table width="100%">
                <tr>
                    <td><asp:Button ID="btn_delete" runat="server" Text="Reject" class="btn btn-danger transparent-style mr-3" CommandName="delete" Width="98%"/></td>
                    <td><asp:Button ID="btn_approve" runat="server" Text="Approve" class="btn btn-success transparent-style mr-3" CommandName="approve" Width="98%"/></td>
                </tr>
            </table>
