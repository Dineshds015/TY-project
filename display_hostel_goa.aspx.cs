...
public partial class display_hostel_goa : System.Web.UI.Page
{
    ...
    private void commentct()
    {
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("select * from tbl_property where p_cat='Hostel' and city='Goa' AND p_status NOT IN ('Approve')", con);
