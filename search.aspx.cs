...
public partial class search : System.Web.UI.Page
{
    ...
    private void commentct()
    {
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("select * from tbl_property where p_cat='" + txt_search.Text + "'", con);
    ...
    protected void dlc_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        if (e.CommandName == "enquiry")
        {
            ...
            else
            {
                ...
                string s1 = "insert into tbl_enquiry (e_cat,e_email,e_image,e_pricing,e_owner,e_pin,e_city,e_features,e_address) values ('" + p_type + "','" + session + "','" + image + "','" + price + "','" + email + "'," + pincode + ",'" + city + "','" + feature + "','" + address + "')";
