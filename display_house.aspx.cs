...
public partial class display_house : System.Web.UI.Page
{
    ...
    private void commentct()
    {
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("select * from tbl_property where p_cat='House' AND p_status NOT IN ('Approve')", con);
    ...
    protected void dlc_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        if (e.CommandName == "enquiry")
        {
            ...
            else
            {
                ...
                string s1 = "insert into tbl_enquiry (e_cat,e_email,e_image,e_pricing,e_duration,e_owner,e_pin,e_city,e_features,e_address,p_id,e_time,e_status) values ('" + p_type + "','" + session + "','" + image + "','" + price + "','" + duration + "','" + email + "'," + pincode + ",'" + city + "','" + feature + "','" + address + "','" + prod_id + "','" + DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss") + "','Pending')";
                string s2 = "insert into tbl_enquiry_temp (e_cat,e_email,e_image,e_pricing,e_duration,e_owner,e_pin,e_city,e_features,e_address,p_id,e_status) values ('" + p_type + "','" + session + "','" + image + "','" + price + "','" + duration + "','" + email + "'," + pincode + ",'" + city + "','" + feature + "','" + address + "','" + prod_id + "','Pending')";
