...
public partial class display_books_surat : System.Web.UI.Page
{
    ...
    private void commentct()
    {
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("select * from tbl_property where p_cat='Books' and city='Surat' AND p_status NOT IN ('Approve')", con);
