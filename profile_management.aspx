<%@ Page Language="C#" AutoEventWireup="true" CodeFile="profile_management.aspx.cs" Inherits="profile_management" %>
        		...
        		<div class="panel-heading"> 
			    	<h3 class="panel-title"><%Response.Write(Session["a"]);%> <small>Hello</small></h3>
			 		...
			 		<div class="panel-body mx-auto" style="width: 200px;">
                        ...
                        <asp:Button ID="btn_add" runat="server" class="btn btn-info btn-block" Text="My Post" OnClick="btn_add_Click" />  <br /><br />
