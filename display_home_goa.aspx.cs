...
public partial class display_home_goa : System.Web.UI.Page
{
    ...
    private void commentct()
    {
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("select * from tbl_property where p_cat='House' and city='Goa' AND p_status NOT IN ('Approve')", con);
